...
double StochasticUzawaSolver::compute_slackness() {
...
Matrix StochasticUzawaSolver::simulate_signal() {
...
// Getter methods
const Matrix& StochasticUzawaSolver::get_price() const {
    return price;
}

const Matrix& StochasticUzawaSolver::get_u() const {
    if (!u) {
...
const Matrix& StochasticUzawaSolver::get_X() const {
    if (!X_u) {
...
const Matrix& StochasticUzawaSolver::get_lambda1() const {
...
const Matrix& StochasticUzawaSolver::get_lambda2() const {
...
const Matrix& StochasticUzawaSolver::get_lambda3() const {
...
const Matrix& StochasticUzawaSolver::get_lambda4() const {
...
const Vector& StochasticUzawaSolver::get_time_grid() const {
    return time_grid;
}

std::size_t StochasticUzawaSolver::iterations() const {
    return n;
}
